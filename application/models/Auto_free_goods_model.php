...
class Auto_free_goods_model extends CI_Model {
    ...
    public function update_to_free_goods_orders($items,$id,$trans_type=null){
    ...
    public function select_unsent_fg(){

        $this->ddb = $this->load->database('default_56', true);
        $sql = "select  ref as po_id,reference as ref,supplier_email from
                (select trans_id as ref,reference from refs
                where trans_id IN
                (
                select order_no from purch_orders where 
                cast(trans_date as date) >='2019-04-01'
                and cast(trans_date as date) <= '2019-04-30'
                and trans_type = '19'
                ) and trans_type = '19'
                ) as a INNER JOIN purch_orders as p
                on a.ref = p.order_no and trans_type = '19' and email = 0 ORDER BY trans_date DESC"; 
