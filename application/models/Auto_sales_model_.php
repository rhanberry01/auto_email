...
class Auto_sales_model_ extends CI_Model {
    ...
    public function select_unsent_po(){
        ...
        // $sql = "select  ref as po_id,reference as ref,trim(supplier_email) as supplier_email, auto_generate from
        //         (select trans_id as ref,reference from refs
        //         where trans_id IN
        //         (
        //         select order_no from purch_orders where 
        //         cast(trans_date as date) >= '2019-10-01'
        //         and cast(trans_date as date) <= '2019-10-20'
        //         and trans_type = '16'
        //         ) and trans_type = '16'
        //         ) as a INNER JOIN purch_orders as p
        //         on a.ref = p.order_no and trans_type = '16' and email = 0  AND supplier_email != '' ORDER BY trans_date DESC"; 
