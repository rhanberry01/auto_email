...
class Auto_free_goods extends CI_Controller {
	
	public function __construct(){
		date_default_timezone_set('Asia/Manila');	
		parent::__construct();
		$this->load->model("Auto_free_goods_model","db_con");
	}
    ...
    public function trans_status(){
        ...
        $branch = $this->db_con->get_po_list_breif($po,FG1_TRANS);
        $branch = $branch[0];
        ...
        $pdf->Cell(70, 15, "Free Goods", 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $pdf->Ln(5);
        ...
        $get_po_details = $this->db_con->get_po_details($branch->order_no,FG1_TRANS);
        ...
        foreach($get_po_details as $row) {
            ...
            $pdf->Cell($w[4], 6, ' '.number_format(0,2).' ', 0, 0, 'R', $fill);
            $total = 0;
            $discTxt = "";
        ...
        // $pdf->Cell($w[6], 6, num($qty_total), 0, 0, 'R', $fill);
        // // $pdf->Cell($w[5], 6, null, 0, 0, 'R', $fill);
        ...
        // $pdf->Cell($w[3], 6, num($pdf->getPageHeight() - (PDF_MARGIN_BOTTOM+13)), 0, 0, 'R', $fill);
        $pdf->Cell($w[4], 6, null, 0, 0, 'R', $fill);
        // $pdf->SetFont('courier', null, 8);
        $pdf->SetFont('helvetica', 'B', 14);
        $pdf->Cell($w[5], 6,  number_format($po_total,2), 0, 0, 'R', $fill);
        // $pdf->Cell($w[5], 6,  num($pdf->GetY()), 0, 0, 'R', $fill);
        // $pdf->Cell($w[6], 6, num($po_total), 0, 0, 'R', $fill);
        // $pdf->Cell($w[5], 6, null, 0, 0, 'R', $fill);
        ...
        $comment  = "";
        $comments = $this->db_con->get_po_comments($branch->order_no,FG1_TRANS);
        // echo $this->db->last_query();
        if(count($comments) > 0 )
        {
        ...
        $pdf->Ln();
        $prepared_by = $this->db_con->get_po_prepared_by(19, $branch->order_no);
        $prepared_by_sign = $prepared_by[0]->sign;
        $prepared_by = $prepared_by[0]->prepared_by;
        
        $approved_by = $this->db_con->get_po_approved_by(19, $branch->order_no);
	  ...
	  public function email_sample(){
       ...
       // $this->load->model("srs/cus_model");
       // $this->session->set_userdata("user", array("id" => 26));
       // $this->load->library("../controllers/srs/po");
       // $this->load->model('site/ref_model');



        $unset_po_list = $this->db_con->select_unsent_fg();

        foreach ($unset_po_list as $list) {
            # code...
          // echo $list->ref.PHP_EOL;
             echo $list->supplier_email.PHP_EOL;
            // echo $list->po_id.PHP_EOL;
// .;
            $email_adds = explode(';',$list->supplier_email.';srs@srssulit.com');
         //
         //   $email_adds = explode(';',  $list->supplier_email);
			//$email = 'eyem_yu@yahoo.com;galupoadonezamae@gmail.com';
            //$email_adds = explode(';',$email);
            $this->send_po_mail_test($list->po_id,$list->ref,$email_adds);
        }

       //  $this->po->send_po_mail();
	...
	public function send_po_mail_test($po_id ='',$ref='',$recipient=null){
		...
		//	    //Server settings
			 // $mail->SMTPDebug = 2;                                 // Enable verbose debug output
                ...
                $mail->Host = 'mail.srssulit.com'; //"smtp.gmail.com";      // setting GMail as our SMTP server
		 ...
		 // $mail->Username   = 'sanroquesupermarket2009@gmail.com'; //"myusername@gmail.com";  // user email address
			     // $mail->Username   = 'srssulitsrs2009@gmail.com'; //"myusername@gmail.com";  // user email address
			//   $mail->Username   = 'srssulit2009@gmail.com'; //"myusername@gmail.com";  // user email address
			  //  $mail->Username   = 'sanroquesupermarkets2009@gmail.com'; //"myusername@gmail.com";  // user email address
			 //   $mail->Username   = 'srssanroque2009@gmail.com'; //"myusername@gmail.com";  // user email address
			 //$mail->Username   = 'srssanroquesupermarket2009@gmail.com'; //"myusername@gmail.com";  // user email address
			//$mail->Username   = 'srssanroquesupermarkets2009@gmail.com'; //"myusername@gmail.com";  // user email address
		//$mail->Username   = 'srsanroquesupermarkets2009@gmail.com'; //"myusername@gmail.com";  // user email address
           		
			//$mail->Username = "sanroquesupermarketsrs2009@gmail.com";
		    //$mail->Username = "sanroquesupermarket12009@gmail.com";

			    //$mail->Username = "sanroquesupermarket22009@gmail.com";
			    //$mail->Username = "sanroquesupermarket32009@gmail.com";
			   //$mail->Username = "sanroquesupermarket42009@gmail.com";
			    // $mail->Username = "sanroquesupermarket62009@gmail.com";
			    // $mail->Username = "sanroquesupermarket72009@gmail.com";
			//$mail->Username = "sanroquesupermarket82009@gmail.com";
			//$mail->Username = "sanroquesupermarket92009@gmail.com";
			//$mail->Username = "sanroquesupermarket102009@gmail.com";
           		//$mail->Username = "sanroquesupermarket112009@gmail.com";
           //	$mail->Username = "sanroquesupermarket122009@gmail.com";
           		//$mail->Username = "sanroquesupermarket132009@gmail.com";
           		//$mail->Username = "sulitsrs2009@gmail.com";
           		//$mail->Username = "sulitsrs12009@gmail.com";
           		//$mail->Username = "sulitsrs22009@gmail.com";
           		$mail->Password   = 'isdnoreply2019';  

           		                          // SMTP password
                        // Enable TLS encryption, `ssl` also accepted
                              // TCP port to connect to maam okay lang po ba palit ako net sige sige

			    //Recipients
			    $mail->setFrom('no-reply@srssulit.com', 'SAN ROQUE SUPERMARKET');
               // $mail->addAddress('mohairan.salunayanm@gmail.com', 'rhan');
			  // $mail->addAddress('bataljade9614@gmail.com', 'Joe User');     // Add a recipient
			    // $mail->addAddress('mohairan.salunayanm@gmail.com');               // Name is optional
			    // $mail->addReplyTo('mohairan.salunayanm@gmail.com', 'Information');

			    /* $mail->addCC('erickskiph@yahoo.com');
			     $mail->addCC('erickskiph320@gmail.com');*/
			     //$mail->addBCC('mohairan.salunayanm@gmail.com');
            ...
            if(!$mail->Send()) {
                ...
                //site_alert($mail->ErrorInfo,"error");
                //$mail->ErrorInfo.
                ...
                // site_alert('Purchase Order '.$ref.' Email Sent to '.$recs,"success"); //temporarily removed [02242016], moved alert to PO js
	            $mail_items = array(
	                        "email"=>1
	                    );
	             $this->db_con->update_to_free_goods_orders($mail_items,$po_id,19);
